  require 'oauth2'
  API_KEY = '16k7wi51gfrm' #Your app's API key
  API_SECRET = 'rvGAHWyoOq3hbqi9' #Your app's API secret
  REDIRECT_URI = 'http://www.kashyapmaduri.com' #Redirect users after authentication to this path, ensure that you have set up your routes to handle the callbacks
  STATE = 'DCEEFWF45453sdffef424'
  #SecureRandom.hex(15) #A unique long string that is not easy to guess
